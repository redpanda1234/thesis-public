...
def draw_first_loop(l, boxed=False):
    """
...
def write_file(draw_func, filename, size, boxed=False):
    """
    ...
    Turtle._pen = t
    draw_func(boxed=boxed)
    drawing.save()


def myloops(boxed=False):
    l = 800
    draw_first_loop(l, boxed=boxed)
    l /= 2
    while l > 0.005:
        draw_loop(l, boxed=boxed)
        l /= 2
    return
...
if __name__ == "__main__":
    ...
    write_file(myloops, "loops-boxed.svg", size=("4000px", "4000px"), boxed=True)
