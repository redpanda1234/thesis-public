...
\begin{tikzpicture}[scale=2]
  ...
  \def\drawss{
    ...
    \coordinate (baanc) at (-0.49118365014453463, 0.015270365886968507);
    \coordinate (bbanc) at (-0.11155607588286276, -0.6728046124623113);
    \pgfmathsetmacro{\bat}{0.7106413035693515}
    \pgfmathsetmacro{\bbt}{0.35806098650698454}
    \pgfmathsetmacro{\batc}{1-\bat}
    \pgfmathsetmacro{\bbtc}{1-\bbt}

    % \node[circle, fill=white, draw=black, inner sep=1pt] () at (v) {};
    % \node[circle, fill=white, draw=black, inner sep=1pt] () at (u) {};
    % \node[circle, fill=black, inner sep=1pt] (v) at (v) {};
