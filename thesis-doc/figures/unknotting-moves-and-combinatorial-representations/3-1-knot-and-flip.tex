...
\begin{tikzpicture}[every node/.style={scale=.75, circle, draw, fill=none,
  ...
  \def\drawshit{
    ...
    \node[fill=black!80!white, text=white] (3) at (3, 0)
    {$3_{\phantom{o}}^{\rm mid}$};
    ...
    \draw[black!80!white, line width=1.5pt]  (.5, 0) -- (1uin)
    (1uout) -- (2oin)  (2oout) -- (3uin)  (3uout) -- (3.5, 0) -- (3.5,
    1) -- (1, 1) -- (1oin)  (1oout) -- (1, -.5) -- (2, -.5) -- (2uin)
    (2uout) -- (2, .5) -- (3, .5) -- (3oin)  (3oout) -- (3, -.5) --
    (4, -.5) -- (4,0) -- (4.5, 0) ;
    \draw[blue, dashed] (0.5, -.625) rectangle (4.5, 1.125);
  }
  ...
  \draw[|->,  thick] (2.5, -1em) to[bend left=40] (2.5, -4em);
  \draw[dotted, thick] (.25, -2.5em) -- (4.75, -2.5em);
