...
\draw[line width=1pt, black!80!white] (1oin) -- (1) -- (1oout);
\draw[black!20!white, double distance=1pt] (1uout) -- (1) -- (1uin);
...
\draw[line width=1pt, black!80!white] (2oin) -- (2) -- (2oout);
\draw[black!20!white, double distance=1pt] (2uout) -- (2) -- (2uin);
...
\draw[line width=1pt, black!80!white] (3oin) -- (3) -- (3oout);
\draw[black!20!white, double distance=1pt] (3uout) -- (3) -- (3uin);
